                ...
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-3 col-md-6">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Contact (ex. 9049401133)" maxlength="10" size="10" name="contact" required = "true"><?php if(isset($_GET['m2'])) echo $_GET['m2']; ?>
                            </div>
